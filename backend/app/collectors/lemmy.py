...
class LemmyCollector(BaseCollector):
    ...
    async def _fetch_community(self, base_url: str, community: str, default_country: Optional[str]) -> List[CollectedArticle]:
    ...
    def _parse_post(self, post_data: dict, base_url: str, default_country: Optional[str]) -> Optional[CollectedArticle]:
