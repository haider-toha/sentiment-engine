...
WIKIPEDIA_EDITIONS = [
    ...
    {"lang": "ar", "base": "https://ar.wikipedia.org", "country": None},  # Arabic - multiple countries
...
class WikipediaCollector(BaseCollector):
    ...
    async def _fetch_recent_news_articles(self) -> List[CollectedArticle]:
        ...
        try:
            ...
            news_keywords = [
                "election", "war", "conflict", "president", "minister",
                "government", "parliament", "protest", "crisis", "disaster",
                "earthquake", "hurricane", "pandemic", "outbreak", "summit",
                "agreement", "treaty", "death", "assassination", "coup",
                "referendum", "vote", "legislation", "bill", "law",
            ]
