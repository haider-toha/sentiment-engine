...
FIPS_TO_ISO = {
    "US": "US", "UK": "GB", "FR": "FR", "GM": "DE", "IT": "IT",
    "SP": "ES", "PO": "PT", "NL": "NL", "BE": "BE", "AU": "AT",
    "SZ": "CH", "SW": "SE", "NO": "NO", "DA": "DK", "FI": "FI",
    "PL": "PL", "EZ": "CZ", "HU": "HU", "RO": "RO", "BU": "BG",
    "GR": "GR", "TU": "TR", "RS": "RU", "UP": "UA", "BO": "BY",
    "LH": "LT", "LG": "LV", "EN": "EE", "JA": "JP", "KS": "KR",
    "CH": "CN", "TW": "TW", "HK": "HK", "IN": "IN", "PK": "PK",
    "BG": "BD", "CE": "LK", "NP": "NP", "AF": "AF", "IR": "IR",
    "IZ": "IQ", "IS": "IL", "JO": "JO", "LE": "LB", "SY": "SY",
    "SA": "SA", "AE": "AE", "QA": "QA", "KU": "KW", "BA": "BH",
    "MU": "OM", "YM": "YE", "EG": "EG", "LY": "LY", "AG": "DZ",
    "MO": "MA", "TS": "TN", "SF": "ZA", "NI": "NG", "KE": "KE",
    "ET": "ET", "GH": "GH", "TZ": "TZ", "UG": "UG", "ZI": "ZW",
    "ZA": "ZM", "AO": "AO", "MZ": "MZ", "CG": "CD", "CF": "CG",
    "RW": "RW", "SU": "SD", "SO": "SO", "SN": "SN", "IV": "CI",
    "CM": "CM", "BR": "BR", "AR": "AR", "CI": "CL", "CO": "CO",
    "PE": "PE", "VE": "VE", "EC": "EC", "BL": "BO", "UY": "UY",
    "PA": "PY", "MX": "MX", "GT": "GT", "HO": "HN", "ES": "SV",
    "NU": "NI", "CS": "CR", "PM": "PA", "CU": "CU", "DR": "DO",
    "HA": "HT", "JM": "JM", "TD": "TT", "AS": "AU", "NZ": "NZ",
    "FJ": "FJ", "PP": "PG", "ID": "ID", "MY": "MY", "SN": "SG",
    "TH": "TH", "VM": "VN", "RP": "PH", "BM": "MM", "CB": "KH",
    "LA": "LA", "BN": "BN", "MG": "MN", "KZ": "KZ", "UZ": "UZ",
    "TX": "TM", "TI": "TJ", "KG": "KG", "GG": "GE", "AM": "AM",
    "AJ": "AZ", "CA": "CA", "EI": "IE", "IC": "IS",
}
